      ...
      <div className="metadeEsquerda">
        ...
        <div className="formContainer">
          <div className="formsDiv">
            <label className="formsTitle" htmlFor="">
              email
            </label>
            <input
              className="input"
          ...
          <div className="formsDiv">
            ...
            >
                ...
                <div>
                  <input
                    ...
                    style={{
                      accentColor: "#01362a",
                      transition:
                        "transform 0.2s ease, background-color 0.2s ease", // Smooth animation
              ...
              <button
                className="esqueceuSuaSenha"
                type="submit"
                onClick={() => navigate("/recuperaSenha")}
              >
                esqueceu sua senha?
              </button>
            </div>
          ...
          <div className="formsDiv">
            ...
            >
              <button className="formsButton" type="submit" onClick={login}>
                Login
              </button>
              <button
                className="formsButton formsButtonRegistrar"
                type="submit"
