    ...
    return (
        <footer className={styles.footer}>
            ...
            <div className={styles.divLinks}>
                ...
                <a href="https://www.figma.com/design/PimWxqrNvyG3GYz03faFwm/Time2Play?node-id=266-537&t=rYb5RVJY30BPEYXU-0" className={styles.cookies} target="_blank">Cookies</a>
                <a href="https://www.figma.com/design/PimWxqrNvyG3GYz03faFwm/Time2Play?node-id=266-537&t=rYb5RVJY30BPEYXU-0" className={styles.cookies} target="_blank">Termos de uso</a>
            </div>
        </footer>
    )
}